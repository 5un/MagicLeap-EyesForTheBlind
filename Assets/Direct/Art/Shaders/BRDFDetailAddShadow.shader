...
SubShader {
	...
	Pass {  
		...
		CGPROGRAM
			...
			v2f vert (float4 pos : POSITION, float3 normal : NORMAL, float2 texcoord : TEXCOORD0,float2 texcoord2 : TEXCOORD1, float2 texcoord3 : TEXCOORD2,float3 viewDir : TEXCOORD5)
			{
				v2f o;
